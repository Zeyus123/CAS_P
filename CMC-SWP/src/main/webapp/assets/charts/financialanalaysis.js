am4core.ready(function() {
  ...
  // Themes end
    ...
    var container = am4core.create("financialanalaysis", am4core.Container);
    ...
    createColumn(" Revenue (In Numbers) ", [
    ...
    createPie([
      { "category": "Product 1", "value": 501 }, 
      { "category": "Product 2", "value": 301 }, 
      { "category": "Category 1", "value": 201 }, 
      { "category": "Category 2", "value": 165 }
     ], colors.getIndex(0));
  
    createLine("Expenditure Trend", [
      { "date": new Date(2018, 0, 1, 8, 0, 0), "value": 22 }, 
      { "date": new Date(2018, 0, 1, 9, 0, 0), "value": 25 }, 
      { "date": new Date(2018, 0, 1, 10, 0, 0), "value": 40 }, 
      { "date": new Date(2018, 0, 1, 11, 0, 0), "value": 35 }, 
    ...
    createColumn("Expenditure (In Numbers)", [
      { "date": new Date(2018, 0, 1, 8, 0, 0), "value": 57 }, 
      { "date": new Date(2018, 0, 1, 9, 0, 0), "value": 27 }, 
      { "date": new Date(2018, 0, 1, 10, 0, 0), "value": 24 }, 
      { "date": new Date(2018, 0, 1, 11, 0, 0), "value": 59 }, 
